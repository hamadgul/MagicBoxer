...
with_node \
  ...
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-document-picker" "expo-eas-client" "expo-file-system" "expo-font" "expo-gl" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-mail-composer" "expo-router" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
